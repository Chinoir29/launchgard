...
def main():
    ...
    parser.add_argument(
        "input", type=Path, help="Input file (YAML or markdown) with user requirements"
    )
    ...
    parser.add_argument("--version", action="version", version="ARCHI-Ω v1.2")
